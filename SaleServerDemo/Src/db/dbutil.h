...
public:
    ...
    */
     ...
     * @return 返回 string list.
     */
    static QStringList selectMuFieldsString(const QString &sql, quint8 fieldCount,
                                            const QVariantMap &params = QVariantMap());
     ...
     * @param fieldCount 字段个数
     * @param params
     * @return 返回 list < string list>.
     */
    static QList<QStringList> selectMuFieldsStrings(const QString &sql,quint8 fieldCount,
                                                    const QVariantMap &params = QVariantMap());
